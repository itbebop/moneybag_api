...
CREATE TABLE asset_pallete (
    colorId        INT AUTO_INCREMENT PRIMARY KEY,
    colorStr       VARCHAR(20),
    colorOrder     INT NOT NULL,
    assetId         INT,
    CONSTRAINT fk_asset_pallete FOREIGN KEY (assetId) REFERENCES assets(assetId) ON DELETE CASCADE
);
...
CREATE TABLE assets (
    ...
    CONSTRAINT fk_asset_firstColor FOREIGN KEY (firstColor) REFERENCES asset_pallete(colorId) ON DELETE CASCADE,
    CONSTRAINT fk_asset_secondColor FOREIGN KEY (secondColor) REFERENCES asset_pallete(colorId) ON DELETE CASCADE
);
...
CREATE TABLE user_asset (
    ...
    -- CONSTRAINT fk_user_asset_firstColor FOREIGN KEY (firstColor) REFERENCES asset_pallete(colorId) ON DELETE CASCADE,
    -- CONSTRAINT fk_user_asset_secondColor FOREIGN KEY (secondColor) REFERENCES asset_pallete(colorId) ON DELETE CASCADE
);

INSERT INTO asset_pallete (colorStr, colorOrder) VALUES
('#FFFFFFFF', 1),
('#FF9E9E9E', 2),
('#FFE91E63', 3),
('#FFF44336', 4),
